...
def upload_file():
    if request.method == 'POST':
        ...
        img1 = image.load_img(path, target_size=(224,224))  # Modified this line
        img1 = image.img_to_array(img1)  # Added this line
        img1 = np.expand_dims(img1, axis=0)  # Modified this line
        img1 = preprocess_input(img1)  # Modified this line
